...
@timeit timer "Force" function Force!(
    ...
    myrank == 0 && Print_Force("Core_Force", Natom, CoreForce)
    ...
    for loop = 1:MPI_size
        ...
        for Nc = 1:GridN_Atom[atom]
            ...
            if r > 1e-14
                ...
                tmp0 = Dr_KumoF(Spe_Num_Mesh_PAO, xx, Spe_PAO_RV, Spe_Atomic_Den)
                ...
                tmp0 = 0.5*Dr_KumoF(Spe_Num_Mesh_VPS, xx, Spe_VPS_RV, Spe_Atomic_PCC)
...
@timeit timer "Force3" function Force3_nospin(pao::Vector{PAO}, Orbs_Grid, Vpot_Grid, DM, ucell::UCell)
    ...
    for loop = 1:MPI_size
        ...
        sumx1 = _Calc_Force3_8(NO0, NO1, MPI_NumOLG[loop], GridListAtom[atom], 
                               MPI_GListTAtoms1[loop], MPI_GListTAtoms2[loop], dOrbs_Grid[1][atom], Orbs_Grid[jatom], Vpot_Grid[1], DM[1][atom][Rn])

        sumy1 = _Calc_Force3_8(NO0, NO1, MPI_NumOLG[loop], GridListAtom[atom], 
                               MPI_GListTAtoms1[loop], MPI_GListTAtoms2[loop], dOrbs_Grid[2][atom], Orbs_Grid[jatom], Vpot_Grid[1], DM[1][atom][Rn])

        sumz1 = _Calc_Force3_8(NO0, NO1, MPI_NumOLG[loop], GridListAtom[atom], 
                               MPI_GListTAtoms1[loop], MPI_GListTAtoms2[loop], dOrbs_Grid[3][atom], Orbs_Grid[jatom], Vpot_Grid[1], DM[1][atom][Rn])
...
@timeit timer "Force3" function Force3_spin(pao::Vector{PAO}, Orbs_Grid, Vpot_Grid, DM, ucell::UCell)
    ...
    for loop = 1:MPI_size
        ...
        sumx1  = _Calc_Force3_8(NO0, NO1, MPI_NumOLG[loop], GridListAtom[atom], 
                                MPI_GListTAtoms1[loop], MPI_GListTAtoms2[loop], dOrbs_Grid[1][atom], Orbs_Grid[jatom], Vpot_Grid[1], DM[1][atom][Rn])
        sumx1 += _Calc_Force3_8(NO0, NO1, MPI_NumOLG[loop], GridListAtom[atom], 
                                MPI_GListTAtoms1[loop], MPI_GListTAtoms2[loop], dOrbs_Grid[1][atom], Orbs_Grid[jatom], Vpot_Grid[2], DM[2][atom][Rn])

        sumy1  = _Calc_Force3_8(NO0, NO1, MPI_NumOLG[loop], GridListAtom[atom], 
                                MPI_GListTAtoms1[loop], MPI_GListTAtoms2[loop], dOrbs_Grid[2][atom], Orbs_Grid[jatom], Vpot_Grid[1], DM[1][atom][Rn])
        sumy1 += _Calc_Force3_8(NO0, NO1, MPI_NumOLG[loop], GridListAtom[atom], 
                                MPI_GListTAtoms1[loop], MPI_GListTAtoms2[loop], dOrbs_Grid[2][atom], Orbs_Grid[jatom], Vpot_Grid[2], DM[2][atom][Rn])

        sumz1  = _Calc_Force3_8(NO0, NO1, MPI_NumOLG[loop], GridListAtom[atom], 
                                MPI_GListTAtoms1[loop], MPI_GListTAtoms2[loop], dOrbs_Grid[3][atom], Orbs_Grid[jatom], Vpot_Grid[1], DM[1][atom][Rn])
        sumz1 += _Calc_Force3_8(NO0, NO1, MPI_NumOLG[loop], GridListAtom[atom], 
                                MPI_GListTAtoms1[loop], MPI_GListTAtoms2[loop], dOrbs_Grid[3][atom], Orbs_Grid[jatom], Vpot_Grid[2], DM[2][atom][Rn])
...
@timeit timer "Force3" function Force3_nc(pao::Vector{PAO}, Orbs_Grid, dVHart_Grid, Vxc_Grid, DM, ucell::UCell)
    ...
    for loop = 1:MPI_size
        ...
        sumx11 = _Calc_Force3_8(NO0, NO1, MPI_NumOLG[loop], GridListAtom[atom], 
                                MPI_GListTAtoms1[loop], MPI_GListTAtoms2[loop], dOrbs_Grid[1][atom], Orbs_Grid[jatom], Vpot1, DM[1][atom][Rn])
        sumx12 = _Calc_Force3_8(NO0, NO1, MPI_NumOLG[loop], GridListAtom[atom], 
                                MPI_GListTAtoms1[loop], MPI_GListTAtoms2[loop], dOrbs_Grid[1][atom], Orbs_Grid[jatom], Vpot2, DM[2][atom][Rn])
        sumx13 = _Calc_Force3_8(NO0, NO1, MPI_NumOLG[loop], GridListAtom[atom], 
                                MPI_GListTAtoms1[loop], MPI_GListTAtoms2[loop], dOrbs_Grid[1][atom], Orbs_Grid[jatom], Vxc_Grid[3], DM[3][atom][Rn])
        sumx14 = _Calc_Force3_8(NO0, NO1, MPI_NumOLG[loop], GridListAtom[atom], 
                                MPI_GListTAtoms1[loop], MPI_GListTAtoms2[loop], dOrbs_Grid[1][atom], Orbs_Grid[jatom], Vxc_Grid[4], DM[4][atom][Rn])
                                
        sumy11 = _Calc_Force3_8(NO0, NO1, MPI_NumOLG[loop], GridListAtom[atom], 
                                MPI_GListTAtoms1[loop], MPI_GListTAtoms2[loop], dOrbs_Grid[2][atom], Orbs_Grid[jatom], Vpot1, DM[1][atom][Rn])
        sumy12 = _Calc_Force3_8(NO0, NO1, MPI_NumOLG[loop], GridListAtom[atom], 
                                MPI_GListTAtoms1[loop], MPI_GListTAtoms2[loop], dOrbs_Grid[2][atom], Orbs_Grid[jatom], Vpot2, DM[3][atom][Rn])
        sumy13 = _Calc_Force3_8(NO0, NO1, MPI_NumOLG[loop], GridListAtom[atom], 
                                MPI_GListTAtoms1[loop], MPI_GListTAtoms2[loop], dOrbs_Grid[2][atom], Orbs_Grid[jatom], Vxc_Grid[3], DM[3][atom][Rn])
        sumy14 = _Calc_Force3_8(NO0, NO1, MPI_NumOLG[loop], GridListAtom[atom], 
                                MPI_GListTAtoms1[loop], MPI_GListTAtoms2[loop], dOrbs_Grid[2][atom], Orbs_Grid[jatom], Vxc_Grid[4], DM[4][atom][Rn])

        sumz11 = _Calc_Force3_8(NO0, NO1, MPI_NumOLG[loop], GridListAtom[atom], 
                                MPI_GListTAtoms1[loop], MPI_GListTAtoms2[loop], dOrbs_Grid[3][atom], Orbs_Grid[jatom], Vpot1, DM[1][atom][Rn])
        sumz12 = _Calc_Force3_8(NO0, NO1, MPI_NumOLG[loop], GridListAtom[atom], 
                                MPI_GListTAtoms1[loop], MPI_GListTAtoms2[loop], dOrbs_Grid[3][atom], Orbs_Grid[jatom], Vpot2, DM[2][atom][Rn])
        sumz13 = _Calc_Force3_8(NO0, NO1, MPI_NumOLG[loop], GridListAtom[atom], 
                                MPI_GListTAtoms1[loop], MPI_GListTAtoms2[loop], dOrbs_Grid[3][atom], Orbs_Grid[jatom], Vxc_Grid[3], DM[3][atom][Rn])
        sumz14 = _Calc_Force3_8(NO0, NO1, MPI_NumOLG[loop], GridListAtom[atom], 
                                MPI_GListTAtoms1[loop], MPI_GListTAtoms2[loop], dOrbs_Grid[3][atom], Orbs_Grid[jatom], Vxc_Grid[4], DM[4][atom][Rn])
...
@timeit timer "HVNA_Force" function HVNA_Force(SpinPol, DS_VNA, HVNA2, HVNA3, HVNA, DM, system_grid::System_Grid)
    ...
    Set_DS_VNA_Natom_1!(atom_old, OneDatom, OneDFNAN, HVNA_FNAN, MP_FNAN, FNAN, Total_NumOrbs, VNATotal_Num, DS_VNA)
    ...
    for loop = 1:MPI_size
        ...
        if atom ≠ atom_old
            Set_DS_VNA_Natom_1!(atom, OneDatom, OneDFNAN, HVNA_FNAN, MP_FNAN, FNAN, Total_NumOrbs, VNATotal_Num, DS_VNA)
        end
...
@timeit timer "Exc_Force" function Exc_Force(pao::Vector{PAO}, pspot::Vector{Pspot}, system_grid::System_Grid)
    ...
    for atom = 1:Natom
        ...
        for Rn = 2:FNAN[atom]+1
            ...
            ExcForce[jatom,1] += 2*pi*Rcut*sum_rx[Rn]
            ExcForce[jatom,2] += 2*pi*Rcut*sum_ry[Rn]
            ExcForce[jatom,3] += 2*pi*Rcut*sum_rz[Rn]

            ExcForce[atom,1] -= 2*pi*Rcut*sum_rx[Rn]
            ExcForce[atom,2] -= 2*pi*Rcut*sum_ry[Rn]
            ExcForce[atom,3] -= 2*pi*Rcut*sum_rz[Rn]
        end
    end
    MPI.Barrier(comm)
...
function Set_DM2DM_Vec(DM, system_grid::System_Grid)
    ...
    for spin = 1:Nspin
        ...
        for atom = 1:Natom, Rn = 1:FNAN[atom]+1, ist = 1:Total_NumOrbs[atom], jst = 1:Total_NumOrbs[natn[atom][Rn]]
            counts += 1
            DM_Vec[spin][atom][Rn][ist][jst] = DM[spin][counts]
        end
	end
...
function Set_DS_VNA_Natom_1!(atom, OneDatom, OneDFNAN, HVNA_FNAN, MP_FNAN, FNAN, Total_NumOrbs, VNATotal_Num, DS_VNA)
...
function dHVNA!(
    ...
    elseif Rn == Rm && Rn ≠ 1
        ...
        if Rn == 1
            ...
            for ist = 1:NO0, jst = 1:NO1
                Sumx = -dot(DS_VNA[2][Natom+1][kl1][ist], DS_VNA[1][Natom+1][kl2][jst])
                Sumy = -dot(DS_VNA[3][Natom+1][kl1][ist], DS_VNA[1][Natom+1][kl2][jst])
                Sumz = -dot(DS_VNA[4][Natom+1][kl1][ist], DS_VNA[1][Natom+1][kl2][jst])
            ...
            if Rm ≠ 1
                for ist = 1:NO0, jst = 1:NO1
                    Sumx = -dot(DS_VNA[2][Natom+1][kl2][jst], DS_VNA[1][Natom+1][kl1][ist])
                    Sumy = -dot(DS_VNA[3][Natom+1][kl2][jst], DS_VNA[1][Natom+1][kl1][ist])
                    Sumz = -dot(DS_VNA[4][Natom+1][kl2][jst], DS_VNA[1][Natom+1][kl1][ist])
...
function dHNL_NC!(
    ...
    elseif where_flag == 0
        for k = 1:FNAN[atom]+1
            ...
            kl = RMI[atom][Rn][k]
            if kl >= 0
                dHNL_SO!(1, Hx, Hy, Hz, NO1, NO0, -1.0, Atoms_Num_RVPS[kg], Atoms_VNLE[kg], Atoms_VPS_List[kg], NLP[1][ig][kl+1], NLP[2][jg][kl+1], NLP[3][jg][kl+1], NLP[4][jg][kl+1])
            end
        end
    else
...
function dHNL_SO!(
    ...
    for ist = 1:NO0, jst = 1:NO1
        ...
        Sum0x = ComplexF64(0.0, 0.0)
        Sum0y = ComplexF64(0.0, 0.0)
        Sum0z = ComplexF64(0.0, 0.0)
        Sum1x = ComplexF64(0.0, 0.0)
        Sum1y = ComplexF64(0.0, 0.0)
        Sum1z = ComplexF64(0.0, 0.0)
        Sum2x = ComplexF64(0.0, 0.0)
        Sum2y = ComplexF64(0.0, 0.0)
        Sum2z = ComplexF64(0.0, 0.0)
        ...
        for lnum = 1:Spe_Num_RVPS
            ...
            # TODO: このl2if内でPrecompile errorが出る
            ...
            if l2 == 2
                ...
                # real contribution of l+1/2 to off diagonal up-down matrix
                tmpx = (tmp*NLP[2][atom][Rn][ist][1][l  ]*NLP[1][jatom][Rm][jst][1][l+2] 
                       -tmp*NLP[2][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l  ])
                tmpy = (tmp*NLP[3][atom][Rn][ist][1][l  ]*NLP[1][jatom][Rm][jst][1][l+2] 
                       -tmp*NLP[3][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l  ])
                tmpz = (tmp*NLP[4][atom][Rn][ist][1][l  ]*NLP[1][jatom][Rm][jst][1][l+2] 
                       -tmp*NLP[4][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l  ])
                ...
                # imaginary contribution of l+1/2 to off diagonal up-down matrix
                tmpx = (-tmp*NLP[2][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l+2] 
                        +tmp*NLP[2][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l+1])
                tmpy = (-tmp*NLP[3][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l+2] 
                        +tmp*NLP[3][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l+1])
                tmpz = (-tmp*NLP[4][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l+2] 
                        +tmp*NLP[4][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l+1])
                ...
                # real contribution of l-1/2 for to diagonal up-down matrix
                tmpx = (tmp*NLP[2][atom][Rn][ist][2][l  ]*NLP[1][jatom][Rm][jst][2][l+2] 
                       -tmp*NLP[2][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l  ])
                tmpy = (tmp*NLP[3][atom][Rn][ist][2][l  ]*NLP[1][jatom][Rm][jst][2][l+2] 
                       -tmp*NLP[3][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l  ])
                tmpz = (tmp*NLP[4][atom][Rn][ist][2][l  ]*NLP[1][jatom][Rm][jst][2][l+2] 
                       -tmp*NLP[4][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l  ])
                ...
                # imaginary contribution of l-1/2 to off diagonal up-down matrix
                tmpx = (-tmp*NLP[2][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l+2] 
                        +tmp*NLP[2][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l+1])
                tmpy = (-tmp*NLP[3][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l+2] 
                        +tmp*NLP[3][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l+1])
                tmpz = (-tmp*NLP[4][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l+2] 
                        +tmp*NLP[4][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l+1])
            ...
            if l2 == 4
                ...
                # real contribution of l+1/2 to off diagonal up-down matrix
                tmpx = (-tmp2*NLP[2][atom][Rn][ist][1][l  ]*NLP[1][jatom][Rm][jst][1][l+3] 
                        +tmp2*NLP[2][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l  ]
                        +tmp1*NLP[2][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l+3] 
                        -tmp1*NLP[2][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+1]
                        +tmp1*NLP[2][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l+4] 
                        -tmp1*NLP[2][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+2])
                tmpy = (-tmp2*NLP[3][atom][Rn][ist][1][l  ]*NLP[1][jatom][Rm][jst][1][l+3] 
                        +tmp2*NLP[3][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l  ]
                        +tmp1*NLP[3][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l+3] 
                        -tmp1*NLP[3][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+1]
                        +tmp1*NLP[3][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l+4] 
                        -tmp1*NLP[3][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+2])
                tmpz = (-tmp2*NLP[4][atom][Rn][ist][1][l  ]*NLP[1][jatom][Rm][jst][1][l+3] 
                        +tmp2*NLP[4][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l  ]
                        +tmp1*NLP[4][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l+3] 
                        -tmp1*NLP[4][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+1]
                        +tmp1*NLP[4][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l+4] 
                        -tmp1*NLP[4][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+2])
                ...
                # imaginary contribution of l+1/2 to off diagonal up-down matrix
                tmpx = ( tmp2*NLP[2][atom][Rn][ist][1][l  ]*NLP[1][jatom][Rm][jst][1][l+4] 
                        -tmp2*NLP[2][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l  ]
                        +tmp1*NLP[2][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l+4] 
                        -tmp1*NLP[2][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+1]
                        -tmp1*NLP[2][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l+3] 
                        +tmp1*NLP[2][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+2])
                tmpy = ( tmp2*NLP[3][atom][Rn][ist][1][l  ]*NLP[1][jatom][Rm][jst][1][l+4] 
                        -tmp2*NLP[3][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l  ]
                        +tmp1*NLP[3][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l+4] 
                        -tmp1*NLP[3][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+1]
                        -tmp1*NLP[3][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l+3] 
                        +tmp1*NLP[3][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+2])
                tmpz = ( tmp2*NLP[4][atom][Rn][ist][1][l  ]*NLP[1][jatom][Rm][jst][1][l+4] 
                        -tmp2*NLP[4][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l  ]
                        +tmp1*NLP[4][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l+4] 
                        -tmp1*NLP[4][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+1]
                        -tmp1*NLP[4][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l+3] 
                        +tmp1*NLP[4][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+2])
                ...
                # real contribution of l-1/2 for to diagonal up-down matrix
                tmpx = (-tmp2*NLP[2][atom][Rn][ist][2][l  ]*NLP[1][jatom][Rm][jst][2][l+3] 
                        +tmp2*NLP[2][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l  ]
                        +tmp1*NLP[2][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l+3] 
                        -tmp1*NLP[2][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l+1]
                        +tmp1*NLP[2][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l+4] 
                        -tmp1*NLP[2][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l+2])
                tmpy = (-tmp2*NLP[3][atom][Rn][ist][2][l  ]*NLP[1][jatom][Rm][jst][2][l+3] 
                        +tmp2*NLP[3][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l  ]
                        +tmp1*NLP[3][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l+3] 
                        -tmp1*NLP[3][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l+1]
                        +tmp1*NLP[3][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l+4] 
                        -tmp1*NLP[3][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l+2])
                tmpz = (-tmp2*NLP[4][atom][Rn][ist][2][l  ]*NLP[1][jatom][Rm][jst][2][l+3] 
                        +tmp2*NLP[4][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l  ]
                        +tmp1*NLP[4][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l+3] 
                        -tmp1*NLP[4][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l+1]
                        +tmp1*NLP[4][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l+4] 
                        -tmp1*NLP[4][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l+2])
                ...
                # imaginary contribution of l-1/2 to off diagonal up-down matrix
                tmpx = ( tmp2*NLP[2][atom][Rn][ist][2][l  ]*NLP[1][jatom][Rm][jst][2][l+4] 
                        -tmp2*NLP[2][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l  ]
                        +tmp1*NLP[2][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l+4] 
                        -tmp1*NLP[2][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l+1]
                        -tmp1*NLP[2][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l+3] 
                        +tmp1*NLP[2][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l+2])
                tmpy = ( tmp2*NLP[3][atom][Rn][ist][2][l  ]*NLP[1][jatom][Rm][jst][2][l+4] 
                        -tmp2*NLP[3][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l  ]
                        +tmp1*NLP[3][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l+4] 
                        -tmp1*NLP[3][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l+1]
                        -tmp1*NLP[3][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l+3] 
                        +tmp1*NLP[3][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l+2])
                tmpz = ( tmp2*NLP[4][atom][Rn][ist][2][l  ]*NLP[1][jatom][Rm][jst][2][l+4] 
                        -tmp2*NLP[4][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l  ]
                        +tmp1*NLP[4][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l+4] 
                        -tmp1*NLP[4][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l+1]
                        -tmp1*NLP[4][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l+3] 
                        +tmp1*NLP[4][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l+2])
            ...
            if l2 == 6
                ...
                tmpx = (-tmp6*NLP[2][atom][Rn][ist][1][l  ]*NLP[1][jatom][Rm][jst][1][l+1] 
                        +tmp6*NLP[2][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l  ]
                        -tmp5*NLP[2][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l+3] 
                        +tmp5*NLP[2][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+1]
                        -tmp5*NLP[2][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l+4] 
                        +tmp5*NLP[2][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+2]
                        -tmp4*NLP[2][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+5] 
                        +tmp4*NLP[2][atom][Rn][ist][1][l+5]*NLP[1][jatom][Rm][jst][1][l+3]
                        -tmp4*NLP[2][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+6] 
                        +tmp4*NLP[2][atom][Rn][ist][1][l+6]*NLP[1][jatom][Rm][jst][1][l+4])
                tmpy = (-tmp6*NLP[3][atom][Rn][ist][1][l  ]*NLP[1][jatom][Rm][jst][1][l+1] 
                        +tmp6*NLP[3][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l  ]
                        -tmp5*NLP[3][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l+3] 
                        +tmp5*NLP[3][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+1]
                        -tmp5*NLP[3][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l+4] 
                        +tmp5*NLP[3][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+2]
                        -tmp4*NLP[3][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+5] 
                        +tmp4*NLP[3][atom][Rn][ist][1][l+5]*NLP[1][jatom][Rm][jst][1][l+3]
                        -tmp4*NLP[3][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+6] 
                        +tmp4*NLP[3][atom][Rn][ist][1][l+6]*NLP[1][jatom][Rm][jst][1][l+4])
                tmpz = (-tmp6*NLP[4][atom][Rn][ist][1][l  ]*NLP[1][jatom][Rm][jst][1][l+1] 
                        +tmp6*NLP[4][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l  ]
                        -tmp5*NLP[4][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l+3] 
                        +tmp5*NLP[4][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+1]
                        -tmp5*NLP[4][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l+4] 
                        +tmp5*NLP[4][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+2]
                        -tmp4*NLP[4][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+5] 
                        +tmp4*NLP[4][atom][Rn][ist][1][l+5]*NLP[1][jatom][Rm][jst][1][l+3]
                        -tmp4*NLP[4][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+6] 
                        +tmp4*NLP[4][atom][Rn][ist][1][l+6]*NLP[1][jatom][Rm][jst][1][l+4])
                ...
                # imaginary contribution of l+1/2 to off diagonal up-down matrix
                tmpx = ( tmp6*NLP[2][atom][Rn][ist][1][l  ]*NLP[1][jatom][Rm][jst][1][l+2] 
                        -tmp6*NLP[2][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l  ]
                        +tmp5*NLP[2][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l+4] 
                        -tmp5*NLP[2][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+1]
                        -tmp5*NLP[2][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l+3] 
                        +tmp5*NLP[2][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+2]
                        +tmp4*NLP[2][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+6] 
                        -tmp4*NLP[2][atom][Rn][ist][1][l+6]*NLP[1][jatom][Rm][jst][1][l+3]
                        -tmp4*NLP[2][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+5] 
                        +tmp4*NLP[2][atom][Rn][ist][1][l+5]*NLP[1][jatom][Rm][jst][1][l+4])
                tmpy = ( tmp6*NLP[3][atom][Rn][ist][1][l  ]*NLP[1][jatom][Rm][jst][1][l+2] 
                        -tmp6*NLP[3][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l  ]
                        +tmp5*NLP[3][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l+4] 
                        -tmp5*NLP[3][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+1]
                        -tmp5*NLP[3][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l+3] 
                        +tmp5*NLP[3][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+2]
                        +tmp4*NLP[3][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+6] 
                        -tmp4*NLP[3][atom][Rn][ist][1][l+6]*NLP[1][jatom][Rm][jst][1][l+3]
                        -tmp4*NLP[3][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+5] 
                        +tmp4*NLP[3][atom][Rn][ist][1][l+5]*NLP[1][jatom][Rm][jst][1][l+4])
                tmpz = ( tmp6*NLP[4][atom][Rn][ist][1][l  ]*NLP[1][jatom][Rm][jst][1][l+2] 
                        -tmp6*NLP[4][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l  ]
                        +tmp5*NLP[4][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l+4] 
                        -tmp5*NLP[4][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+1]
                        -tmp5*NLP[4][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l+3] 
                        +tmp5*NLP[4][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+2]
                        +tmp4*NLP[4][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+6] 
                        -tmp4*NLP[4][atom][Rn][ist][1][l+6]*NLP[1][jatom][Rm][jst][1][l+3]
                        -tmp4*NLP[4][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+5] 
                        +tmp4*NLP[4][atom][Rn][ist][1][l+5]*NLP[1][jatom][Rm][jst][1][l+4])
                ...
                tmpx = (-tmp6*NLP[2][atom][Rn][ist][2][l  ]*NLP[1][jatom][Rm][jst][2][l+1] 
                        +tmp6*NLP[2][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l  ]
                        -tmp5*NLP[2][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l+3] 
                        +tmp5*NLP[2][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l+1]
                        -tmp5*NLP[2][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l+4] 
                        +tmp5*NLP[2][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l+2]
                        -tmp4*NLP[2][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l+5] 
                        +tmp4*NLP[2][atom][Rn][ist][2][l+5]*NLP[1][jatom][Rm][jst][2][l+3]
                        -tmp4*NLP[2][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l+6] 
                        +tmp4*NLP[2][atom][Rn][ist][2][l+6]*NLP[1][jatom][Rm][jst][2][l+4])
                tmpy = (-tmp6*NLP[3][atom][Rn][ist][2][l  ]*NLP[1][jatom][Rm][jst][2][l+1] 
                        +tmp6*NLP[3][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l  ]
                        -tmp5*NLP[3][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l+3] 
                        +tmp5*NLP[3][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l+1]
                        -tmp5*NLP[3][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l+4] 
                        +tmp5*NLP[3][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l+2]
                        -tmp4*NLP[3][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l+5] 
                        +tmp4*NLP[3][atom][Rn][ist][2][l+5]*NLP[1][jatom][Rm][jst][2][l+3]
                        -tmp4*NLP[3][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l+6] 
                        +tmp4*NLP[3][atom][Rn][ist][2][l+6]*NLP[1][jatom][Rm][jst][2][l+4])
                tmpz = (-tmp6*NLP[4][atom][Rn][ist][2][l  ]*NLP[1][jatom][Rm][jst][2][l+1] 
                        +tmp6*NLP[4][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l  ]
                        -tmp5*NLP[4][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l+3] 
                        +tmp5*NLP[4][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l+1]
                        -tmp5*NLP[4][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l+4] 
                        +tmp5*NLP[4][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l+2]
                        -tmp4*NLP[4][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l+5] 
                        +tmp4*NLP[4][atom][Rn][ist][2][l+5]*NLP[1][jatom][Rm][jst][2][l+3]
                        -tmp4*NLP[4][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l+6] 
                        +tmp4*NLP[4][atom][Rn][ist][2][l+6]*NLP[1][jatom][Rm][jst][2][l+4])
                ...
                # imaginary contribution of l-1/2 to off diagonal up-down matrix
                tmpx = ( tmp6*NLP[2][atom][Rn][ist][2][l  ]*NLP[1][jatom][Rm][jst][2][l+2] 
                        -tmp6*NLP[2][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l  ]
                        +tmp5*NLP[2][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l+4] 
                        -tmp5*NLP[2][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l+1]
                        -tmp5*NLP[2][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l+3] 
                        +tmp5*NLP[2][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l+2]
                        +tmp4*NLP[2][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l+6] 
                        -tmp4*NLP[2][atom][Rn][ist][2][l+6]*NLP[1][jatom][Rm][jst][2][l+3]
                        -tmp4*NLP[2][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l+5] 
                        +tmp4*NLP[2][atom][Rn][ist][2][l+5]*NLP[1][jatom][Rm][jst][2][l+4])
                tmpy = ( tmp6*NLP[3][atom][Rn][ist][2][l  ]*NLP[1][jatom][Rm][jst][2][l+2] 
                        -tmp6*NLP[3][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l  ]
                        +tmp5*NLP[3][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l+4] 
                        -tmp5*NLP[3][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l+1]
                        -tmp5*NLP[3][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l+3] 
                        +tmp5*NLP[3][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l+2]
                        +tmp4*NLP[3][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l+6] 
                        -tmp4*NLP[3][atom][Rn][ist][2][l+6]*NLP[1][jatom][Rm][jst][2][l+3]
                        -tmp4*NLP[3][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l+5] 
                        +tmp4*NLP[3][atom][Rn][ist][2][l+5]*NLP[1][jatom][Rm][jst][2][l+4])
                tmpz = ( tmp6*NLP[4][atom][Rn][ist][2][l  ]*NLP[1][jatom][Rm][jst][2][l+2] 
                        -tmp6*NLP[4][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l  ]
                        +tmp5*NLP[4][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l+4] 
                        -tmp5*NLP[4][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l+1]
                        -tmp5*NLP[4][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l+3] 
                        +tmp5*NLP[4][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l+2]
                        +tmp4*NLP[4][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l+6] 
                        -tmp4*NLP[4][atom][Rn][ist][2][l+6]*NLP[1][jatom][Rm][jst][2][l+3]
                        -tmp4*NLP[4][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l+5] 
                        +tmp4*NLP[4][atom][Rn][ist][2][l+5]*NLP[1][jatom][Rm][jst][2][l+4])
            ...
            if l2 == 2
                ...
                tmpx = (tmp*NLP[2][atom][Rn][ist][1][l  ]*NLP[1][jatom][Rm][jst][1][l+1] 
                       -tmp*NLP[2][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l  ])
                tmpy = (tmp*NLP[3][atom][Rn][ist][1][l  ]*NLP[1][jatom][Rm][jst][1][l+1] 
                       -tmp*NLP[3][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l  ])
                tmpz = (tmp*NLP[4][atom][Rn][ist][1][l  ]*NLP[1][jatom][Rm][jst][1][l+1] 
                       -tmp*NLP[4][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l  ])
                ...
                tmpx = (tmp*NLP[2][atom][Rn][ist][2][l  ]*NLP[1][jatom][Rm][jst][2][l+1] 
                       -tmp*NLP[2][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l  ])
                tmpy = (tmp*NLP[3][atom][Rn][ist][2][l  ]*NLP[1][jatom][Rm][jst][2][l+1] 
                       -tmp*NLP[3][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l  ])
                tmpz = (tmp*NLP[4][atom][Rn][ist][2][l  ]*NLP[1][jatom][Rm][jst][2][l+1] 
                       -tmp*NLP[4][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l  ])
            ...
            if l2 == 4
                ...
                tmpx = ( tmp2*NLP[2][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l+2] 
                        -tmp2*NLP[2][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l+1]
                        +tmp1*NLP[2][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+4] 
                        -tmp1*NLP[2][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+3])
                tmpy = ( tmp2*NLP[3][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l+2] 
                        -tmp2*NLP[3][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l+1]
                        +tmp1*NLP[3][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+4] 
                        -tmp1*NLP[3][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+3])
                tmpz = ( tmp2*NLP[4][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l+2] 
                        -tmp2*NLP[4][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l+1]
                        +tmp1*NLP[4][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+4] 
                        -tmp1*NLP[4][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+3])
                ...
                tmpx = ( tmp2*NLP[2][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l+2] 
                        -tmp2*NLP[2][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l+1]
                        +tmp1*NLP[2][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l+4] 
                        -tmp1*NLP[2][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l+3])
                tmpy = ( tmp2*NLP[3][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l+2] 
                        -tmp2*NLP[3][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l+1]
                        +tmp1*NLP[3][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l+4] 
                        -tmp1*NLP[3][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l+3])
                tmpz = ( tmp2*NLP[4][atom][Rn][ist][2][l+1]*NLP[1][jatom][Rm][jst][2][l+2] 
                        -tmp2*NLP[4][atom][Rn][ist][2][l+2]*NLP[1][jatom][Rm][jst][2][l+1]
                        +tmp1*NLP[4][atom][Rn][ist][2][l+3]*NLP[1][jatom][Rm][jst][2][l+4] 
                        -tmp1*NLP[4][atom][Rn][ist][2][l+4]*NLP[1][jatom][Rm][jst][2][l+3])
            ...
            if l2 == 6
                ...
                tmpx = ( tmp1*NLP[2][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l+2] 
                        -tmp1*NLP[2][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l+1]
                        +tmp2*NLP[2][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+4] 
                        -tmp2*NLP[2][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+3]
                        +tmp3*NLP[2][atom][Rn][ist][1][l+5]*NLP[1][jatom][Rm][jst][1][l+6] 
                        -tmp3*NLP[2][atom][Rn][ist][1][l+6]*NLP[1][jatom][Rm][jst][1][l+5])
                tmpy = ( tmp1*NLP[3][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l+2] 
                        -tmp1*NLP[3][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l+1]
                        +tmp2*NLP[3][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+4] 
                        -tmp2*NLP[3][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+3]
                        +tmp3*NLP[3][atom][Rn][ist][1][l+5]*NLP[1][jatom][Rm][jst][1][l+6] 
                        -tmp3*NLP[3][atom][Rn][ist][1][l+6]*NLP[1][jatom][Rm][jst][1][l+5])
                tmpz = ( tmp1*NLP[4][atom][Rn][ist][1][l+1]*NLP[1][jatom][Rm][jst][1][l+2] 
                        -tmp1*NLP[4][atom][Rn][ist][1][l+2]*NLP[1][jatom][Rm][jst][1][l+1]
                        +tmp2*NLP[4][atom][Rn][ist][1][l+3]*NLP[1][jatom][Rm][jst][1][l+4] 
                        -tmp2*NLP[4][atom][Rn][ist][1][l+4]*NLP[1][jatom][Rm][jst][1][l+3]
                        +tmp3*NLP[4][atom][Rn][ist][1][l+5]*NLP[1][jatom][Rm][jst][1][l+6] 
                        -tmp3*NLP[4][atom][Rn][ist][1][l+6]*NLP[1][jatom][Rm][jst][1][l+5])
            ...
            for lll = 0:l2
                ...
                # VNL for j=l+1/2
                tmpx = PFp*ene_p*NLP[2][atom][Rn][ist][1][l]*NLP[1][jatom][Rm][jst][1][l]
                tmpy = PFp*ene_p*NLP[3][atom][Rn][ist][1][l]*NLP[1][jatom][Rm][jst][1][l]
                tmpz = PFp*ene_p*NLP[4][atom][Rn][ist][1][l]*NLP[1][jatom][Rm][jst][1][l]
                ...
                # VNL for j=l-1/2
                tmpx = PFm*ene_m*NLP[2][atom][Rn][ist][2][l]*NLP[1][jatom][Rm][jst][2][l]
                tmpy = PFm*ene_m*NLP[3][atom][Rn][ist][2][l]*NLP[1][jatom][Rm][jst][2][l]
                tmpz = PFm*ene_m*NLP[4][atom][Rn][ist][2][l]*NLP[1][jatom][Rm][jst][2][l]
...
function _Calc_Force3_8(NO0, NO1, NumOLG, GridListAtom, GListTAtoms1, GListTAtoms2, dOrbs_Grid, Orbs_Grid, Vpot_Grid, DM)
	...
	for Nog = 1:8:NumOLG-7
		...
		for ist = 1:NO0
			Sum0 = temp0 * dOrbs_Grid[ist][Nc0]
			Sum1 = temp1 * dOrbs_Grid[ist][Nc1]
			Sum2 = temp2 * dOrbs_Grid[ist][Nc2]
			Sum3 = temp3 * dOrbs_Grid[ist][Nc3]
			Sum4 = temp4 * dOrbs_Grid[ist][Nc4]
			Sum5 = temp5 * dOrbs_Grid[ist][Nc5]
			Sum6 = temp6 * dOrbs_Grid[ist][Nc6]
			Sum7 = temp7 * dOrbs_Grid[ist][Nc7]
			for jst = 1:NO1
				Sum += Sum0 * Orbs_Grid[jst][Nh0] * DM[ist][jst]
				Sum += Sum1 * Orbs_Grid[jst][Nh1] * DM[ist][jst]
				Sum += Sum2 * Orbs_Grid[jst][Nh2] * DM[ist][jst]
				Sum += Sum3 * Orbs_Grid[jst][Nh3] * DM[ist][jst]
				Sum += Sum4 * Orbs_Grid[jst][Nh4] * DM[ist][jst]
				Sum += Sum5 * Orbs_Grid[jst][Nh5] * DM[ist][jst]
				Sum += Sum6 * Orbs_Grid[jst][Nh6] * DM[ist][jst]
				Sum += Sum7 * Orbs_Grid[jst][Nh7] * DM[ist][jst]
			end
		end
	end
    ...
    for Nog = 1:rem_NumOLG
        ...
        temp = Vpot_Grid[MN]
        for ist = 1:NO0
            Sum1 = temp * dOrbs_Grid[ist][Nc]
            for jst = 1:NO1
                Sum += Sum1 * Orbs_Grid[jst][Nh] * DM[ist][jst]
            end
        end
    end
