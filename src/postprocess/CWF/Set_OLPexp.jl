function Set_OLPexp(cwf_setup::Union{CWF_Setup,CWF_Setup_MO}, tot_bvector, bvector)
...
function Set_OLPexp!(tot_bvector, bvector, OLPexp, Orbs_Grid, ucell::UCell)
    ...
    for ib = 1:tot_bvector, loop = 1:Nloop
