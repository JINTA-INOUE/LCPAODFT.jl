...
function Write_PDos_gnuplot(filename::String, Dos_Erange)
    ...
    println(gnu_file, "# set yra [ymin:ymax]")
    println(gnu_file, "set size 1")
    println(gnu_file, "plot \"$(filename).PDOS.Tetrahedron.orb1\" using 1:2 with lines linewidth 3 title \"\"")
    println(gnu_file, "# replot \"$(filename).PDOS.Tetrahedron.orb2\" using 1:2 with lines linewidth 3 title \"\"")

    println(gnu_file, "")
    println(gnu_file, "set term pdf size 5in, 4in")
    println(gnu_file, "set output \"$(filename).PDOS_Tetrahedron_orb1.pdf\"")
    println(gnu_file, "replot")
    close(gnu_file)
end