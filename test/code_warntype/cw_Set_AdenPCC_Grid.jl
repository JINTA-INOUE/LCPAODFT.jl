...
function check_Set_AdenPCC_Grid_code_warntype()
    verbosity = 0
    ...
    @code_warntype Set_AdenPCC_Grid(SpinPol, Init_Atoms_Nspin, Init_Atoms_Angle, [pao], [pspot], ucell)
end

check_Set_AdenPCC_Grid_code_warntype()