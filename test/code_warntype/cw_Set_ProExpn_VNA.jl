...
function check_Set_ProExpn_code_warntype()
    verbosity = 0
    ...
    @code_warntype Set_ProExpn!(HVNA, [pao], [pspot], system_grid)
end


function check_Set_VNA2_code_warntype()
    verbosity = 0
    Latvecs = [5.10 0.00 5.10; 0.00 5.10 5.10; 5.10 5.10 0.00]
    Natom = 2
    atom2spe = [1, 1]
    ...
    @code_warntype Set_VNA2!(HVNA2, [pao], [pspot], system_grid)
end


# check_Set_ProExpn_code_warntype()
# check_Set_VNA2_code_warntype()